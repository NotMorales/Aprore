    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                ...
                <!--begin::Form-->
                <form method="POST" action="{{ route('postulante.update', $postulante->id) }}" autocomplete="off">
                    @csrf
                    @method('PATCH')
                    <div class="card-body">
                        @if ( $errors->any() )
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre', $postulante->user->persona->nombre) }}" id="nombre" name="nombre" placeholder="Luis Antonio" />
                        </div>

                        <div class="form-group">
                            <label for="apellido_paterno">Apellido Paterno: <span class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('apellido_paterno') is-invalid @enderror" value="{{ old('apellido_paterno', $postulante->user->persona->apellido_paterno) }}" id="apellido_paterno" name="apellido_paterno" placeholder="Morales" />
                        </div>

                        <div class="form-group">
                            <label for="apellido_materno">Apellido Materno: <span class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('apellido_materno') is-invalid @enderror" value="{{ old('apellido_materno', $postulante->user->persona->apellido_materno) }}" id="apellido_materno" name="apellido_materno" placeholder="Velazquez" />
                        </div>

                        <div class="form-group">
                            <label for="sexo">Sexo <span class="text-danger">*</span> </label>
                            <select class="form-control @error('sexo') is-invalid @enderror" id="sexo" name="sexo">
                                <option value="Masculino" {{ 'Masculino' ==  $postulante->user->persona->sexo ? ' selected' : ''}}>Hombre</option>
