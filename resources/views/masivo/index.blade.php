                ...
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">Registro de Personal:
                            <span class="d-block text-info text-danger pt-2 font-size-sm">La importacion masiva debe respetar la plantilla de muestra.</span></h3>
                        </div>
                        <div class="card-toolbar">
                            <x-boton class="btn-primary" title="Descargar Plantilla">
                            <x-slot name="svg">
                            ...
                            {{ route('postulantemasivo.plantilla') }}
                        </x-boton>
                    </div>
                </div>
                <!--begin::Form-->
