...
@section('content')
    <x-subheader title="Empresas"
        :subheaders="[ ['href'=>'empresa.index', 'nombre'=>'Inicio'], ['href'=>'empresa.index', 'nombre'=>'Crear'], ['href'=>'empresa.index', 'nombre'=>'Staff'] ]"
        :acciones="[]">
    </x-subheader>
        ...
        <div class="container">
            <div class="card card-custom">
                <div class="card-header">
                    <h3 class="card-title">Formulario de Registro Usuario Staff</h3>
                </div>
                <!--begin::Form-->
                <form method="POST" action="{{ route('empresa.staff.store', $empresa) }}" autocomplete="off">
                    @csrf
                    <div class="card-body">
                        @if ( $errors->any() )
                            <x-errors></x-errors>
