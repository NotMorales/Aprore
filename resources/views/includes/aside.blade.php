    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                @endcan
                @can('havemodulo', 'Registro de Nomina')
                    <li class="menu-section">
                        <h4 class="menu-text">Registro de Nomina</h4>
                        <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                    </li>
                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                        <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                @can('havepermiso', 'Trabajador.index')
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('postulante.index') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">Ver Trabajadores</span>
                                        </a>
                                    </li>
                                @endcan
                                @can('havepermiso', 'Trabajador.create')
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('postulante.create') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">Registro de postulante</span>
                                        </a>
                                    </li>
                                @endcan
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="" class="menu-link">
                                        ...
                                        <span class="menu-text">Seguimiento de postulante</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
