    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                ...
                <!--begin::Form-->
                <form method="POST" action="{{ route('expediente.update', $postulante->id) }}" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="card-body">
                        @if ( $errors->any() )
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('postulante.index') }}" class="btn btn-secondary">Cancelar</a>
                    </div>
                </form>
                <!--end::Form-->
            </div>
