    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <x-noticia>
                ...
                Los Areas podran ser modificadas unicamente por Aprore. <br>
                <a href="https://www.facebook.com/luis.morales.velazquez/" target="_blank">Comunicarme con TI.</a>
            </x-noticia>
            <div class="card card-custom">
                <div class="card-header">
                    <h3 class="card-title">Formulario de Registro de Area</h3>
                ...
                <!--begin::Form-->
                <form method="POST" action="{{ route('sucursal.area.store', $sucursal) }}" autocomplete="off">
                    @csrf
                    <div class="card-body">
                        @if ( $errors->any() )
                            <x-errors></x-errors>
