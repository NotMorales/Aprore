                ...
                <form method="POST" action="{{ route('postulante.informacion.store', $postulante->id) }}" autocomplete="off">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" oninput="validarInput(this)" class="form-control @error('curp') is-invalid @enderror" value="{{ old('curp') }}" id="curp" name="curp" placeholder="MOVL991024GHXDSC06" />
